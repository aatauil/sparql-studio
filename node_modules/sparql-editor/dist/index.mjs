...
import { Parser as Parser2 } from "sparqljs";
...
import { Parser as Parser3, Generator } from "sparqljs";
var parser2 = new Parser3();
...
// src/index.ts
var sparqlKeywordCompletions = SparqlLanguage.data.of({
  autocomplete: keywordCompletionSource
});
var sparqlLocalCompletions = SparqlLanguage.data.of({
